...
module TzinfoJs
  class TzinfoDefinition
    ...
    attr_accessor :sorted_transitions
    ...
    def transition(year, month, offset_id, numerator_or_timestamp, denominator_or_numerator = nil, denominator = nil)
      ...
      if denominator
        ...
        time = (Rational(numerator_or_timestamp, denominator) - Rational(4881175,2))*86400
    ...
    def template_path
      File.expand_path("../templates/tzinfo_definition.js.erb", __FILE__)
    end
